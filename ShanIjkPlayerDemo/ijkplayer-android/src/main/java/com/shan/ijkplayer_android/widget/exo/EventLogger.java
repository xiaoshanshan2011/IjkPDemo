 ...
 */
package com.shan.ijkplayer_android.widget.exo;
...
import com.shan.ijkplayer_android.widget.exo.player.DemoPlayer;
...
public class EventLogger implements DemoPlayer.Listener, DemoPlayer.InfoListener,
  ...
  @Override
  public void onLoadStarted(int sourceId, long length, int type, int trigger, com.google.android.exoplayer.chunk.Format format,
  ...
  @Override
  public void onLoadCompleted(int sourceId, long bytesLoaded, int type, int trigger, com.google.android.exoplayer.chunk.Format format,
  ...
  @Override
  public void onVideoFormatEnabled(com.google.android.exoplayer.chunk.Format format, int trigger, long mediaTimeMs) {
    Log.d(TAG, "videoFormat [" + getSessionTimeString() + ", " + format.id + ", "
        + Integer.toString(trigger) + "]");
  }

  @Override
  public void onAudioFormatEnabled(com.google.android.exoplayer.chunk.Format format, int trigger, long mediaTimeMs) {
